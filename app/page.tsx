...
const urlData: Record<string, { name: string; url: string; description: string }[]> = {
  ...
  Privacy: [
    ...
    { name: 'Nextcloud', url: 'https://nextcloud.com/', description: 'Private cloud storage and collaboration platform.' },
    { name: 'Bitwarden', url: 'https://bitwarden.com/', description: 'Open-source password manager.' },
    { name: 'KeePassXC', url: 'https://keepassxc.org/', description: 'Local password manager.' },
    { name: 'ProtonDrive', url: 'https://proton.me/drive', description: 'Encrypted cloud storage from Proton.' },
    { name: 'Mozilla Firefox (with privacy extensions)', url: 'https://www.mozilla.org/firefox/', description: 'Privacy-focused browser.' },
    { name: 'LibreWolf', url: 'https://librewolf.net/', description: 'Privacy-hardened Firefox fork.' },
    { name: 'NordVPN', url: 'https://nordvpn.com/', description: 'Popular VPN service for online privacy.' },
    { name: 'ExpressVPN', url: 'https://www.expressvpn.com/', description: 'Popular VPN service for online privacy.' },
  ],
  ...
  Development: [
    ...
    { name: 'Jira', url: 'https://www.atlassian.com/software/jira', description: 'Popular project management and issue tracking.' },
    { name: 'Travis CI', url: 'https://travis-ci.com/', description: 'Continuous Integration pipeline.' },
    { name: 'CircleCI', url: 'https://circleci.com/', description: 'Continuous Integration pipeline.' },
    { name: 'Terraform', url: 'https://www.terraform.io/', description: 'Infrastructure as code.' },
    { name: 'Ansible', url: 'https://www.ansible.com/', description: 'Configuration management system.' },
    { name: 'PostgreSQL', url: 'https://www.postgresql.org/', description: 'Popular open-source relational database.' },
    { name: 'MongoDB', url: 'https://www.mongodb.com/', description: 'Popular NoSQL database.' },
    { name: 'Redis', url: 'https://redis.io/', description: 'In-memory data structure store, used as a database, cache, and message broker.' },
    { name: 'Webpack', url: 'https://webpack.js.org/', description: 'Build tool for modern web development.' },
    { name: 'Babel', url: 'https://babeljs.io/', description: 'JavaScript compiler for next generation syntax.' },
    { name: 'ESLint', url: 'https://eslint.org/', description: 'JavaScript and TypeScript code quality tool.' },
    { name: 'Prettier', url: 'https://prettier.io/', description: 'Code formatter supporting many languages.' },
    { name: 'GitKraken', url: 'https://www.gitkraken.com/', description: 'Git client with GUI.' },
    { name: 'SourceTree', url: 'https://www.sourcetreeapp.com/', description: 'Free Git GUI client by Atlassian.' },
    { name: 'Visual Studio Code', url: 'https://code.visualstudio.com/', description: 'Powerful code editor, desktop-based.' },
    { name: 'StackBlitz', url: 'https://stackblitz.com/', description: 'Online IDE focused on web projects.' },
  ],
  ...
  Productivity: [
    { name: 'Notion', url: 'https://www.notion.so/', description: 'All-in-one workspace for notes, tasks, databases, and collaboration.' },
    { name: 'Trello', url: 'https://trello.com/', description: 'Visual project management tool using boards, lists, and cards.' },
    { name: 'Asana', url: 'https://asana.com/', description: 'Task and project management software for teams to track work.' },
    { name: 'Todoist', url: 'https://todoist.com/', description: 'Task management app with powerful organization and collaboration features.' },
    { name: 'Microsoft To Do', url: 'https://todo.microsoft.com/', description: 'Task management app integrated with Microsoft 365 ecosystem.' },
    { name: 'Google Keep', url: 'https://keep.google.com/', description: 'Note-taking service with reminders and collaborative features.' },
    { name: 'Evernote', url: 'https://evernote.com/', description: 'Note-taking app with web clipping, organization, and search capabilities.' },
    { name: 'ClickUp', url: 'https://clickup.com/', description: 'All-in-one productivity platform for tasks, docs, goals, and time tracking.' },
    { name: 'Monday.com', url: 'https://monday.com/', description: 'Work operating system for managing projects, workflows, and team collaboration.' },
    { name: 'Airtable', url: 'https://airtable.com/', description: 'Flexible database tool that combines the simplicity of a spreadsheet with the power of a database.' },
    { name: 'Coda', url: 'https://coda.io/', description: 'Document editor that combines text, tables, and interactive elements in one place.' },
    { name: 'Miro', url: 'https://miro.com/', description: 'Online collaborative whiteboard platform for brainstorming and visual collaboration.' },
    { name: 'Slack', url: 'https://slack.com/', description: 'Team communication platform with channels, direct messages, and integrations.' },
    { name: 'Microsoft Teams', url: 'https://www.microsoft.com/en/microsoft-teams/group-chat-software', description: 'Collaboration platform integrating chat, video calls, and Office 365 tools.' },
  ],
  
  PenetrationTesting: [
    { name: 'Metasploit Framework', url: 'https://www.metasploit.com/', description: 'Popular penetration testing tool.' },
    { name: 'Cuckoo Sandbox', url: 'https://cuckoosandbox.org/', description: 'Malware analysis sandbox.' },
    { name: 'OpenVAS', url: 'https://www.openvas.org/', description: 'Open-source vulnerability scanner.' },
    { name: 'VirusShare', url: 'https://virusshare.com/', description: 'Malware sample repository.' },
    { name: 'Cortex XSOAR (formerly Demisto)', url: 'https://www.paloaltonetworks.com/cortex/cortex-xsoar', description: 'SOAR platform for automated response.' },
    { name: 'MITRE ATT&CK', url: 'https://attack.mitre.org/', description: 'Threat framework knowledge base (for context).' },
    { name: 'OWASP ZAP', url: 'https://www.zaproxy.org/', description: 'Web application security scanner.' },
    { name: 'Burp Suite', url: 'https://portswigger.net/burp', description: 'Integrated platform for performing security testing of web applications.' },
    { name: 'Nmap', url: 'https://nmap.org/', description: 'Network discovery and security auditing tool.' },
    { name: 'Wireshark', url: 'https://www.wireshark.org/', description: 'Network protocol analyzer for troubleshooting and analysis.' },
    { name: 'Nikto', url: 'https://cirt.net/Nikto2', description: 'Web server scanner to detect vulnerabilities.' },
    { name: 'SQLmap', url: 'http://sqlmap.org/', description: 'Automated tool for detecting and exploiting SQL injection flaws.' },
    { name: 'John the Ripper', url: 'https://www.openwall.com/john/', description: 'Fast password cracker.' },
    { name: 'Aircrack-ng', url: 'https://www.aircrack-ng.org/', description: 'Wi-Fi network security testing tools.' },
    { name: 'Hydra', url: 'https://github.com/vanhauser-thc/thc-hydra', description: 'Parallelized login cracker supporting numerous protocols.' },
    { name: 'Responder', url: 'https://github.com/SpiderLabs/Responder', description: 'Lateral movement and credential theft tool.' },
    { name: 'Empire', url: 'https://github.com/EmpireProject/Empire', description: 'Post-exploitation framework.' },
    { name: 'Maltego', url: 'https://www.maltego.com/', description: 'Information gathering and data visualization tool.' },
    { name: 'Social-Engineer Toolkit (SET)', url: 'https://github.com/trustedsec/social-engineer-toolkit', description: 'Framework for social engineering penetration tests.' },
    { name: 'OpenSCAP', url: 'https://www.open-scap.org/', description: 'Compliance and vulnerability scanner with SCAP support.' },
  ],
